...
public class InvoiceServiceImpl implements InvoiceService {
    ...
    @Override
    public void createInvoiceDetailsFromItems(Invoice invoice, List<CartItemRequest> cartItems) {
        for (CartItemRequest cartItem : cartItems) {
            ...
            invoiceDetail.setPrice(cartItem.getPrice().multiply(BigDecimal.valueOf(cartItem.getQuantity())));
