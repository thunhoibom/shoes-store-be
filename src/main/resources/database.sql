...
-- Switch to FREEPDB1 and create schema objects in SNEAKER_USER schema
ALTER SESSION SET CONTAINER = FREEPDB1;

-- Set current schema to SNEAKER_USER so objects are created in the right schema
ALTER SESSION SET CURRENT_SCHEMA = SNEAKER_USER;

-- Verify we're in the right PDB and schema
